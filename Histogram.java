...
public class Histogram {
    public static void main(String[] args) {
        ...
        double percentFirst = countFirst / n * 100;
        double percentSecond = countSecond / n * 100;
        double percentThird = countThird / n * 100;
        double percentForth = countForth / n * 100;
        double percentFifth = countFifth / n * 100;
